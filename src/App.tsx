...
function App() {
  ...
  const technologies = [
    "WordPress", "Elementor", "ReactJS", "HTML5", "CSS3", "JavaScript",
    "PHP", "MySQL", "Google Ads", "Facebook Ads", "Social Media Marketing",
    "Email Campaigns", "WooCommerce", "SEO", "Figma", "Git", "VS Code"
  ];
  ...
  const experience = [
    {
      ...
      technologies: ["WordPress", "Elementor", "WooCommerce", "SEO", "Google Ads", "PPC"]
    },
    {
      ...
      technologies: ["WordPress", "WooCommerce", "Google Ads", "Local SEO", "UX Design"]
    },
    {
      title: "Web Developer / SEO Specialist",
      ...
      technologies: ["WordPress", "SEO Audits", "Google Ads", "Lead Generation", "Site Migration"]
    },
    {
      ...
      technologies: ["WordPress", "Elementor", "SEO", "Web Hosting", "Digital Strategy"]
    }
  ];
  ...
  const projects = [
    {
      ...
      description: "Advanced AI-powered SaaS platform for generating SEO-optimized blog posts. Built with React.js and hosted live with modern web technologies.",
    ...
    },
    {
      ...
      description: "Complete migration project from WordPress to React then NextJS, improving performance and user experience significantly.",
    ...
    },
    {
      ...
      description: "Founded and built comprehensive web development platform for small businesses with WordPress and WHMCS integration.",
    ...
    },
    {
      ...
      description: "Professional cleaning business website built in WordPress with service management and lead generation features.",
    ...
    },
    {
      ...
      description: "Complete platform migration from Joomla to WordPress, modernizing the website architecture and improving functionality for structural steel company.",
    ...
    },
    {
      ...
      description: "Rebuilt WooCommerce site and optimized product pages for better conversion rates and user experience in tile industry.",
    ...
    },
    {
      ...
      description: "Professional beauty clinic website built in WordPress with appointment booking and service showcase for skin treatments.",
      ...
      technologies: ["WordPress", "Beauty Industry", "Responsive Design", "SEO"],
      liveUrl: "https://bellaskinclinic.com.au",
      githubUrl: "https://bellaskinclinic.com.au"
    },
    {
      title: "GetTilesOnline.com.au - SEO & Performance",
      description: "SEO and performance optimization for online tile retailer, improving search rankings and site speed for better user experience.",
      image: "https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=800",
      features: [
        "SEO Optimization",
        "Performance Boost",
    ...
    },
    {
      ...
      description: "Restored and updated hacked website, implemented security measures, and got the site approved by Google after malware removal.",
    ...
    },
    {
      ...
      description: "SEO optimization for category pages, improving search visibility and organic traffic for tile showroom business.",
      image: "https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=800",
      features: [
        "Category Page SEO",
        "Search Visibility",
    ...
    },
    {
      ...
      description: "Service pages SEO optimization that ranked the fencing company in Google top 3 for major keywords, driving significant organic traffic.",
    ...
    },
    {
      ...
      description: "Migrated WordPress legal website to React, achieving 50% speed improvement and modern user experience for law firm.",
  ...
  const stats = [
    { number: "5+", label: "Years Experience", icon: <Calendar className="w-8 h-8 text-blue-600" /> },
    { number: "50+", label: "Projects Completed", icon: <Award className="w-8 h-8 text-blue-600" /> },
    { number: "30+", label: "Happy Clients", icon: <Users className="w-8 h-8 text-blue-600" /> },
    { number: "Sydney", label: "Australia", icon: <MapPin className="w-8 h-8 text-blue-600" /> }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4 animate-fadeInUp">
            <div className="flex items-center space-x-2 hover-scale cursor-pointer">
              ...
              <span className="text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors duration-300">Kamal Khanal</span>
            </div>
            
            {/* Desktop Navigation */}
            <div className="hidden md:flex space-x-8">
              <a href="#home" className="text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110 relative group">
                Home
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#about" className="text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110 relative group">
                About
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#skills" className="text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110 relative group">
                Skills
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#experience" className="text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110 relative group">
                Experience
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#projects" className="text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110 relative group">
                Projects
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
              <a href="#contact" className="text-gray-700 hover:text-blue-600 transition-all duration-300 hover:scale-110 relative group">
                Contact
                <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-blue-600 transition-all duration-300 group-hover:w-full"></span>
              </a>
            </div>
      ...
      {/* Hero Section */}
      <section id="home" className="pt-20 pb-16 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 text-white gradient-animate">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between min-h-[80vh]">
            <div className="lg:w-1/2 mb-8 lg:mb-0 animate-fadeInLeft">
              ...
              <p className="text-lg text-blue-100 mb-8 leading-relaxed max-w-2xl animate-fadeInUp stagger-3">
                ...
                exceptional web experiences that drive results and help businesses 
                grow online.
              </p>
              ...
              <div className="flex gap-6 animate-fadeInUp stagger-5">
                <a href="https://github.com/webkamal" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-200 transition-all duration-300 hover:scale-125 hover:rotate-12">
                  <Github size={24} />
                </a>
                <a href="https://www.linkedin.com/in/khanalkamal/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-200 transition-all duration-300 hover:scale-125 hover:rotate-12">
                  <Linkedin size={24} />
                </a>
                <a href="mailto:hello@kamalkhanal.com" className="text-white hover:text-blue-200 transition-all duration-300 hover:scale-125 hover:rotate-12">
                  <Mail size={24} />
                </a>
                <a href="tel:0415837036" className="text-white hover:text-blue-200 transition-all duration-300 hover:scale-125 hover:rotate-12">
                  <Phone size={24} />
                </a>
              </div>
            </div>
      ...
      <section id="about" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16 animate-fadeInUp">
            <h2 className="text-5xl font-bold text-gray-900 mb-4 hover:text-blue-600 transition-colors duration-300">About Me</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-16 animate-fadeInUp stagger-2">
            <div className="animate-fadeInLeft">
              <p className="text-lg text-gray-600 mb-6 leading-relaxed hover:text-gray-800 transition-colors duration-300">
                I'm an experienced and versatile Web Developer & SEO Specialist with 
                over 5 years of expertise in creating powerful web solutions. Based in 
                Sydney, Australia, I specialize in React, WordPress, and modern web 
                technologies.
              </p>
              <p className="text-lg text-gray-600 mb-6 leading-relaxed hover:text-gray-800 transition-colors duration-300">
                My background in client communication, web hosting, and digital 
                marketing allows me to deliver comprehensive solutions that not only 
                look great but also drive real business results. I'm passionate about clean 
                code, user experience, and staying ahead of industry trends.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed hover:text-gray-800 transition-colors duration-300">
                Currently seeking new opportunities in Sydney to contribute my skills to 
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16 animate-fadeInUp stagger-3">
            {stats.map((stat, index) => (
              <div key={index} className={`text-center hover-lift hover-glow p-6 rounded-xl bg-white shadow-lg animate-bounceIn stagger-${index + 1}`}>
                <div className="flex justify-center mb-4 animate-pulse-custom">
                  {stat.icon}
                </div>
                <div className="text-3xl font-bold text-gray-900 mb-2 hover:text-blue-600 transition-colors duration-300">{stat.number}</div>
                <div className="text-gray-600 hover:text-gray-800 transition-colors duration-300">{stat.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="animate-fadeInUp stagger-4">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 hover:text-blue-600 transition-colors duration-300">Certifications</h3>
            <div className="flex flex-wrap gap-4 animate-fadeInUp stagger-5">
              {certifications.map((cert, index) => (
                <span 
                  key={index}
                  className={`bg-white px-6 py-3 rounded-full border border-gray-200 text-gray-700 font-medium hover:bg-blue-50 hover:border-blue-300 hover:text-blue-700 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fadeInUp stagger-${index + 1}`}
                >
                  {cert}
                </span>
              ))}
      ...
      <section id="skills" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 hover:text-blue-600 transition-colors duration-300">Skills & Expertise</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16 animate-fadeInUp stagger-2">
            {skills.map((skillGroup, index) => (
              <div key={index} className={`bg-gray-50 p-8 rounded-2xl hover-lift hover-glow transition-all duration-500 animate-fadeInUp stagger-${index + 1}`}>
                <div className="flex items-center mb-6 animate-fadeInLeft">
                  {skillGroup.icon}
                  <h3 className="text-xl font-bold text-gray-900 ml-3 hover:text-blue-600 transition-colors duration-300">{skillGroup.category}</h3>
                </div>
                <div className="space-y-4">
                  {skillGroup.skills.map((skill, skillIndex) => (
                    <div key={skillIndex} className="animate-fadeInUp" style={{animationDelay: `${skillIndex * 0.1}s`}}>
                      <div className="flex justify-between items-center mb-2">
                        <span className="font-medium text-gray-700 hover:text-gray-900 transition-colors duration-300">{skill.name}</span>
                        <span className="text-blue-600 font-medium hover:text-blue-800 transition-colors duration-300">{skill.level}%</span>
                      </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16 animate-fadeInUp stagger-3">
            {additionalSkills.map((skill, index) => (
              <div key={index} className={`text-center p-6 hover-lift hover-glow bg-gray-50 rounded-xl transition-all duration-500 animate-bounceIn stagger-${index + 1}`}>
                <div className="flex justify-center mb-4 animate-pulse-custom">
                  {skill.icon}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-2 hover:text-blue-600 transition-colors duration-300">{skill.category}</h3>
                <p className="text-gray-600 hover:text-gray-800 transition-colors duration-300">{skill.description}</p>
              </div>
            ))}
          </div>
          ...
          {/* Tools & Technologies */}
          <div className="animate-fadeInUp stagger-4">
            <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center hover:text-blue-600 transition-colors duration-300">Tools & Technologies</h3>
            <div className="flex flex-wrap justify-center gap-4 animate-fadeInUp stagger-5">
              {technologies.map((tech, index) => (
                <span 
                  key={index}
                  className={`bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-200 hover:text-blue-900 transition-all duration-300 hover:scale-110 hover:shadow-lg animate-fadeInUp stagger-${(index % 6) + 1}`}
                >
                  {tech}
                </span>
              ))}
      ...
      <section id="experience" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 hover:text-blue-600 transition-colors duration-300">Professional Experience</h2>
            <p className="text-xl text-gray-600 hover:text-gray-800 transition-colors duration-300">
          ...
          <div className="space-y-12 animate-fadeInUp stagger-2">
            {experience.map((job, index) => (
              <div key={index} className={`bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 border-l-4 border-blue-600 hover-lift hover-glow animate-fadeInUp stagger-${index + 1}`}>
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  <div className="animate-fadeInLeft">
                    <h3 className="text-2xl font-bold text-gray-900 mb-3 hover:text-blue-600 transition-colors duration-300">{job.title}</h3>
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 text-gray-600 mb-2">
                      <span className="font-semibold text-blue-600 hover:text-blue-800 transition-colors duration-300">{job.company}</span>
                      <span>•</span>
                  ...
                  <div className="flex items-center gap-4 mt-4 lg:mt-0 animate-fadeInRight">
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                      job.status === 'Current' ? 'bg-green-100 text-green-800' : 
                      job.status === 'Founder' ? 'bg-purple-100 text-purple-800' :
                ...
                <ul className="space-y-3 mb-6">
                  {job.achievements.map((achievement, achIndex) => (
                    <li key={achIndex} className={`flex items-start group animate-fadeInLeft stagger-${achIndex + 1}`}>
                      <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0 group-hover:bg-blue-800 transition-colors"></div>
                      <span className="text-gray-700 leading-relaxed group-hover:text-gray-900 transition-colors duration-300">{achievement}</span>
                    </li>
                  ))}
                </ul>
                ...
                <div className="flex flex-wrap gap-3">
                  {job.technologies.map((tech, techIndex) => (
                    <span 
                      key={techIndex}
                      className={`bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 px-4 py-2 rounded-full text-sm font-medium hover:from-blue-100 hover:to-blue-200 transition-all duration-300 hover:scale-105 hover:shadow-lg animate-fadeInUp stagger-${techIndex + 1}`}
                    >
                      {tech}
                    </span>
                  ))}
          ...
          <div className="mt-20 text-center animate-fadeInUp stagger-6">
            <h3 className="text-3xl font-bold text-gray-900 mb-8 hover:text-blue-600 transition-colors duration-300">Education</h3>
            <div className="bg-white p-8 rounded-2xl shadow-lg max-w-2xl mx-auto hover-lift hover-glow transition-all duration-500 animate-bounceIn">
              <h4 className="text-xl font-bold text-gray-900 mb-2 hover:text-blue-600 transition-colors duration-300">Master in Information Technology</h4>
              <p className="text-blue-600 font-semibold mb-2 hover:text-blue-800 transition-colors duration-300">Melbourne Institute of Technology (2008-2010)</p>
              <p className="text-gray-600 hover:text-gray-800 transition-colors duration-300">Specialized in Software Engineering and Web Development</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="projects" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-4xl font-bold text-gray-900 mb-4 hover:text-blue-600 transition-colors duration-300">Featured Projects</h2>
            <p className="text-xl text-gray-600 hover:text-gray-800 transition-colors duration-300">
              A showcase of my recent work in web development, SEO, and digital marketing
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16 animate-fadeInUp stagger-2">
            {projectStats.map((stat, index) => (
              <div key={index} className={`text-center hover-lift hover-glow p-6 rounded-xl bg-gray-50 transition-all duration-500 animate-bounceIn stagger-${index + 1}`}>
                <div className="text-4xl font-bold text-blue-600 mb-2 hover:text-blue-800 transition-colors duration-300 animate-pulse-custom">{stat.number}</div>
                <div className="text-gray-600 hover:text-gray-800 transition-colors duration-300">{stat.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 animate-fadeInUp stagger-3">
            {projects.map((project, index) => (
              <div key={index} className={`bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-500 hover-lift hover-glow animate-fadeInUp stagger-${(index % 4) + 1}`}>
                <img 
                  src={project.image} 
                  alt={project.title}
                ...
                />
                <div className="p-8">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4 hover:text-blue-600 transition-colors duration-300">{project.title}</h3>
                  <p className="text-gray-600 mb-6 leading-relaxed hover:text-gray-800 transition-colors duration-300">{project.description}</p>
                  
                  <div className="mb-6">
                    <h4 className="font-semibold text-gray-900 mb-3 hover:text-blue-600 transition-colors duration-300">Key Features:</h4>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 text-white gradient-animate">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fadeInUp">
            <h2 className="text-4xl font-bold mb-4 hover:text-blue-200 transition-colors duration-300">Let's Work Together</h2>
            <p className="text-xl text-blue-100 hover:text-white transition-colors duration-300">
              Ready to start your next project? I'm available for freelance work and new opportunities.
            </p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 hover-glow transition-all duration-500 animate-fadeInUp stagger-2">
            {formSubmitted ? (
              <div className="text-center py-12 animate-bounceIn">
                ...
                <h3 className="text-3xl font-bold text-white mb-4">Thank you for contacting, I will get back to you shortly 🙏</h3>
                <p className="text-blue-100 text-lg">Your message has been sent successfully!</p>
                <button 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center animate-fadeInUp">
            ...
            <div className="lg:col-span-1 animate-fadeInLeft">
              <h3 className="text-3xl font-bold mb-3 hover:text-blue-200 transition-colors duration-300">Kamal Khanal</h3>
              <p className="text-blue-100 mb-2 hover:text-white transition-colors duration-300">Web Developer & SEO Specialist</p>
              <p className="text-blue-100 hover:text-white transition-colors duration-300">Creating exceptional digital experiences in Sydney</p>
            </div>
            ...
            <div className="lg:col-span-1 text-center animate-fadeInUp">
              ...
              <div className="mb-4">
                <a href="mailto:hello@kamalkhanal.com" className="text-blue-100 hover:text-white transition-colors duration-300 hover:scale-105 inline-block">
            ...
            <div className="lg:col-span-1 flex justify-center lg:justify-end gap-6 animate-fadeInRight">
              <a href="https://github.com/webkamal" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white transition-all duration-300 hover:scale-125 hover:rotate-12 p-2">
                <Github size={28} />
              </a>
              <a href="https://www.linkedin.com/in/khanalkamal/" target="_blank" rel="noopener noreferrer" className="text-blue-100 hover:text-white transition-all duration-300 hover:scale-125 hover:rotate-12 p-2">
                <Linkedin size={28} />
              </a>
              <a href="mailto:hello@kamalkhanal.com" className="text-blue-100 hover:text-white transition-all duration-300 hover:scale-125 hover:rotate-12 p-2">
                <Mail size={28} />
              </a>
            </div>
          </div>
          ...
          <div className="border-t border-blue-500/30 mt-12 pt-8 text-center animate-fadeInUp stagger-2">
            <p className="text-blue-100 hover:text-white transition-colors duration-300">&copy; 2025 Kamal Khanal. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
